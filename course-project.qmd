...
The final project is due on **Sunday December 3rd 11:59pm**. Groups are expected to submit their project electronically to Canvas, similar to how you submit your work for daily activities. You will type your project directly into a qmd file and render an html document. You should **submit both your .html** file (and dataset if you chose one other than the one I provided). **Only ONE person** from the group needs to submit the project. Make sure everyone's name is on the project. Look at your rendered document **before** submitting - your project will be graded as it appears in the submission.
...
Everyone in your group must agree to be in your group. I should not be getting emails stating "*Jane Doe* is in my group and we don't know who that is". If you do not know anyone in the class, Groups 1 - 10 are titled "Random Join". Anyone can join them. You can communicate with your group through the Canvas group, make a group on Campuswire, or exchange email.
...
If you are having group member issues that need to be addressed this must be done prior to Wednesday November 29th.
