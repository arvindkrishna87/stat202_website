...
Toyota claims their fuel efficiency is superior and if you buy one of their cars your average weekly gas spending will be less than \$40. You randomly survey 40 people with a Toyota to obtain the amount of money spent on gas weekly. The results are saved in `data/gas_spending.csv`.
