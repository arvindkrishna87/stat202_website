...
-   $H_0$: $\mu=5$, $\pi=0.5$, $\mu_1-\mu_2=0$, $\beta_1=0$
...
The way you interpret/phrase your conclusion is very important.

-   Example: We will work through Activity 18 Question 1 together.

## One-sample (two-sided) tests

 

| Statistic  | $H_0$         | $H_A$            | Test Statistic (Standardization)                                   | Distribution |
|-------------|-------------|-------------|-------------|-----------------------|
...
|--------------|--------------|--------------|-------------------|--------------|
| Diff. in means       | $\mu_1-\mu_2 = 0$ | $\mu_1-\mu_2 \neq 0$ | $\frac{\bar{x_1} - \bar{x_2}-0}{s_p\sqrt{\frac{1}{n_1}+\frac{1}{n_2}}}$                                                                 | t(df=$n_1$ + $n_2$ -2) |
| Diff. in proportions | $\pi_1-\pi_2 = 0$ | $\pi_1-\pi_2 \neq 0$ | \Large $\frac{(\hat{\pi_1}-\hat{\pi_2}) - d}{\sqrt{\frac{\hat{\pi_0}(1-\hat{\pi_0})}{n_1} + \frac{\hat{\pi_0}(1-\hat{\pi_0})}{n_2} } }$ | N(0,1)                 |
...
| Diff. in proportions | $\pi_1-\pi_2 = d$ | $\pi_1-\pi_2 \neq d$ | \Large $\frac{(\hat{\pi_1}-\hat{\pi_2}) - 0}{\sqrt{\frac{\hat{\pi_1}(1-\hat{\pi_1})}{n_1} + \frac{\hat{\pi_2}(1-\hat{\pi_2})}{n_2} } }$ | N(0,1)                    |
