...
![](images_horst/palmer_penguin_species.png){#id .class width="400px" height="300px"}
:::

::: {.absolute top="60%" left="70%"}
![](images_horst/palmer_penguin.png){#id .class width="300px" height="250px"}
:::
...
![](images_lecture/data_types.png){#id .class width="500px" height="300px"}
