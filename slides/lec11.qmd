...
$$\widehat{bodymass} = -5443.96 + 47.15*flipper + 406.8*0 - 0.29*flipper*0$$
$$\widehat{bodymass} = -5443.96 + 47.15*flipper$$
<br> 

. . .

Equation of the line for male penguins:
$$\widehat{bodymass} = -5443.96 + 47.15*flipper + 406.8*1 - 0.29*flipper*1$$
$$\widehat{bodymass} = -5037.16 + 46.86*flipper$$
