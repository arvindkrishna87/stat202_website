...
Sometimes a survey or dataset will code categorical responses with numbers. This is particularly common for binary categories (two choices).
...
How can we change `Survived` to be treated as a categorical variable?
