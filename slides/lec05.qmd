...
<font size="6">The 'd' stands for data frames, and the 'plyr' is the name of another package that the R developers called pliers. Think of it as a set of metaphorical pliers used for working with data sets and data frames.</font>
