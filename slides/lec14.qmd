...
<img src="images_lecture/normal.jpeg" style="float: center;"/>
:::

:::: {.column width="50%"}
**Properties**

A normal distribution is a continuous probability distribution for a real-valued random variable, with the probability density function as:
