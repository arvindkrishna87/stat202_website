...
Suppose Jill Thrillseeker is going sky diving. Jill will be inspecting the parachute before using it. No matter the inspection, we can never be 100% sure the parachute will work until we pull the rip cord to deploy it. Describe the 4 possible scenarios and their consequences.
...
## Results from the 4 Possible Scenarios
