...
Assessment for the course is comprised of five components: participation, reading checks, activities, projects, midterm exam, and final exam.
...
Students, faculty, and staff must comply with University expectations regarding appropriate classroom behavior, including those outlined below and in the [COVID-19 Code of Conduct](https://www.northwestern.edu/communitystandards/about-us/northwestern-university-student-expectations-covid-19-code-of-conduct.html)[^1]. With respect to classroom procedures, this includes:

[^1]: Internet search: "Northwestern Code of Conduct"
...
\noindent If a student fails to comply with the [COVID-19 Code of Conduct](https://www.northwestern.edu/communitystandards/about-us/northwestern-university-student-expectations-covid-19-code-of-conduct.html) or other University expectations related to COVID-19, the instructor may ask the student to leave the class. The instructor is asked to report the incident to the Office of Community Standards for additional follow-up.
...
\noindent Maintaining the health of the community remains our priority. If you are experiencing any symptoms of COVID **do not attend class** and update your Symptom Tracker application right away to connect with Northwestern's Case Management Team for guidance on next steps. Also contact the instructor as soon as possible to arrange to complete coursework. We plan to record sessions for students that miss to to COVID-19 related issues.

\noindent Students who experience a personal emergency should contact the instructor as soon as possible to arrange to complete coursework.

\noindent Should public health recommendations prevent in person class from being held on a given day, the instructor or the university will notify students.

## Course policies

### Accommodations

Any student requesting accommodations related to a disability or other condition must register with AccessibleNU[^2] and provide the instructor with an accommodation notification from AccessibleNU, preferably within the first two weeks of class. All information will remain confidential.

[^2]: For more info visit <http://www.northwestern.edu/accessiblenu/> or contact accessiblenu\@northwestern.edu; 847.467.5530.

### Recording

Unauthorized student recording of classroom or other academic activities is prohibited.[^3] Unauthorized recording is unethical and may also be a violation of University policy and state law.

[^3]: Including advising sessions or office hours.
...
Students are responsible for reading and understanding [Northwestern's academic integrity policy](http://www.northwestern.edu/provost/students/integrity/)[^4]. Suspected violations of academic integrity will be reported to the Weinberg College Dean's Office[^5].

[^4]: Found at <http://www.northwestern.edu/provost/students/integrity/>

[^5]: See your school's policies for more details, for example [WCAS Policies](http://www.weinberg.northwestern.edu/handbook/integrity/index.html).

### Sexual Misconduct & Reporting

Northwestern University is committed to fostering an environment where students are safe and free from sexual misconduct. Confidential resources are available to those who have experienced sexual misconduct.[^6]

[^6]:  See <http://www.northwestern.edu/sexual-misconduct/get-help/confidential-support.html> for details.
...
We encourage students who have experienced sexual misconduct to talk with someone to get support. For more information, including how to request interim protective measures and academic accommodations or file a complaint, visit the [Get Help](http://www.northwestern.edu/sexual-misconduct/get-help/index.html)[^7].

[^7]: <http://www.northwestern.edu/sexual-misconduct/get-help/index.html>

### Discrimination & Sexual Harassment

Northwestern University's policies on Discrimination, Harassment, and Sexual Harassment apply to all members of the University community, including students, staff, and faculty. Any student, staff, or faculty member who believes that they have been discriminated against or harassed on the basis of his or her race, color, religion, national origin, sex, sexual orientation, gender identity, gender expression, parental status, marital status, age, disability, citizenship, veteran status, genetic information or any other classification protected by law, should contact the Office of Equal Opportunity and Access[^8] or the Sexual Harassment Prevention Office[^9].

[^8]: 847.491.7458

[^9]: 847.467.6571

Additional information about the University's discrimination and harassment policies, including the campus resources available to assist individuals with discrimination or harassment concerns, is available online on the [Human Resources Equal Opportunity and Access website](http://www.northwestern.edu/hr/equlopp-access/index.html)[^10].

[^10]:  <http://www.northwestern.edu/hr/equlopp-access/index.html>

\noindent Northwestern strictly prohibits retaliation against any member of its community for reporting or inquiring about wrongful or unlawful activity. For more details see <https://policies.northwestern.edu/docs/non-retaliation-policy-FINAL.pdf>.
