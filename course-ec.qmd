...
Complete any of the 3 sample exams **prior to the exam date** and upload the completed sample exam to the respective Canvas assignment. Each sample exam will count as 2 bonus points toward activities. Yes, you can get over 100% in this category.

Requirements

-   your name must have a check mark next to it
-   every question must be attempted
-   every question/exercise must be visible for me to see the answer

If you do not complete every one of those requirements you will not get credit. This is checking that you know how to properly submit an exam. It will NOT be graded for accuracy.
